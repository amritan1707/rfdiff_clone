...
# First, we specify we want a C4 symmetric oligomer, and 10 designs, to a specific output path
...
inference.output_prefix=example_outputs/rfdiff_nickel/rfdiff_model \
